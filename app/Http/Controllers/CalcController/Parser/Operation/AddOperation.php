...
use App\Http\Controllers\CalcController\Parser\HasPrecedence\AddSubPrecedence;
use App\Http\Controllers\CalcController\Parser\HasPrecedence\HasPrecedence;

class AddOperation extends Operation implements BinaryOperation, HasPrecedence {
    use AddSubPrecedence;
